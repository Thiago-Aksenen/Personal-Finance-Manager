<x-layout title="Editar despesa">
    <form action="{{ route('despesa.update', $despesa->id) }}" method="post">
        ...
        <select name="categoria">
            <option value="contas" {{ old('categoria', $despesa->categoria) == 'contas' ? 'selected' : '' }}>Contas
            </option>
            <option value="alimentacao" {{ old('categoria', $despesa->categoria) == 'alimentacao' ? 'selected' : '' }}>
                alimentação
            </option>
            <option value="trasporte" {{ old('categoria', $despesa->categoria) == 'transporte' ? 'selected' : '' }}>
                Transporte
            </option>
